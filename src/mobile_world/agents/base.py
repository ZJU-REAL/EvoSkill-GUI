        ...
        **kwargs: Any,
        ...
        while retry_times > 0:
            try:
                ...
                # Disable thinking mode for Qwen3 models to avoid None content.
                # Different backends read the flag from different places:
                #   - native DashScope: extra_body.enable_thinking
                #   - vLLM / most OpenAI-compatible gateways: chat_template_kwargs.enable_thinking
                # Setting both keeps generation short (thinking can blow past the
                # request timeout at ~8k max_tokens).
                if "qwen3" in model.lower() or "qwen36" in model.lower():
